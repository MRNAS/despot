...
if("TRUE" STREQUAL "TRUE")
  set(youbot_gazebo_worlds_SOURCE_PREFIX /home/manuel/taskprocess/ARMTaskProcessCheckers/despot/src/despot_tutorials/robots/youbot/youbot_simulation/youbot_gazebo_worlds)
  set(youbot_gazebo_worlds_DEVEL_PREFIX /home/manuel/taskprocess/ARMTaskProcessCheckers/despot/devel/.private/youbot_gazebo_worlds)
  ...
  set(youbot_gazebo_worlds_INSTALL_PREFIX /home/manuel/taskprocess/ARMTaskProcessCheckers/despot/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'youbot_gazebo_worlds' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'youbot_gazebo_worlds' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/manuel/taskprocess/ARMTaskProcessCheckers/despot/src/despot_tutorials/robots/youbot/youbot_simulation/youbot_gazebo_worlds/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT youbot_gazebo_worlds_NUM_DUMMY_TARGETS)
      set(youbot_gazebo_worlds_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::youbot_gazebo_worlds::wrapped-linker-option${youbot_gazebo_worlds_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR youbot_gazebo_worlds_NUM_DUMMY_TARGETS "${youbot_gazebo_worlds_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::youbot_gazebo_worlds::wrapped-linker-option${youbot_gazebo_worlds_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND youbot_gazebo_worlds_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/manuel/taskprocess/ARMTaskProcessCheckers/despot/devel/.private/youbot_gazebo_worlds/lib;/home/manuel/taskprocess/ARMTaskProcessCheckers/despot/devel/lib;/home/manuel/taskprocess/ARMTaskProcessCheckers/despot/devel/.private/catkin_tools_prebuild/lib;/home/manuel/catkin_ws/devel/lib;/home/manuel/catkin_ws/devel/.private/catkin_tools_prebuild/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${youbot_gazebo_worlds_dep}_FOUND)
      find_package(${youbot_gazebo_worlds_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${youbot_gazebo_worlds_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
